...
import { getCoachProfileForParent, getCoachProfileByCourseId } from '../controllers/parentCoachProfile.js';
...
router.get('/coach/by-course/:courseId',
  [param('courseId').isString().withMessage('Invalid course ID format')],
  validate,
